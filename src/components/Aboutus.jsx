  ...
  const SubscribeBlog = async () => {
    try {
      const response = await axios.post(
        "https://fluxs.onrender.com/subscribe",
        subscribe
      );
      if (!response) {
    ...
    <>
      <div className="aboutus">
        ...
        {loading ? (
          <>
            <div className="flux_intro">
              ...
              <div className="office_img">
                <Skeleton width={400} height={300}  baseColor="#636e72" />
              </div>
            </div>
          ...
          <>
            {/* Your actual content when loading is done */}
            <div className="flux_intro">
              <div className="about_flux">
                <h1>About Flux</h1>
                <p>"About Flux: Pioneering Blogging Excellence Since 2003" At Flux, we're not
